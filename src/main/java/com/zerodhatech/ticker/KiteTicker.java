...
public class KiteTicker {
	 ...
	 * @param apiKey      is the api key of the app which is received after creating
	 *                    an app on developers console.
	 */
	...
	private Tick getIndeciesData(byte[] bin, int x, boolean tradable) {
		...
		// tick.setNetPriceChangeFromClosingPrice(convertToDouble(getBytes(bin, 24, 28))
		// / dec);
